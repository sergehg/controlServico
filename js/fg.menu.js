...
function Menu(caller, options){
	...
	this.chooseItem = function(item){
		...
		switch(textoId){
			...
			break;
			case 'oficina':
				$("#page-heading").html("<h1>Categoria Productos de Oficina</h1>");
				$("#table-content").load('categooficina.php');
			break;
			default:;
		}
